...
val df_School_Locations_2014_2015_schema = StructType(
        ...
        StructField("DBN2",StringType,true)::
...
val df_School_Locations_2014_2015_final = df_School_Locations_2014_2015_ready.selectExpr("Year2",
    "DBN2",
    "Street",
    "City",
    "State",
...
//Create new DF with updated types
val df_School_Locations_2015_2016_final = df_School_Locations_2015_2016_ready.selectExpr("Year2",
    "DBN2",
    "Street",
    "City",
    "State",
...
val df_School_Locations_2016_2017_rdd = dfToRDD_2016_2017.map(line => line.get(0).toString).
    ...
    filter(tup=> !tup._3(0).contains("[null")).
    map(tup=>(tup._2.replace(" ",""), tup._3(0), tup._3(1), tup._3(2), tup._3(3), tup._3(4), tup._3(5))).
    map(line => org.apache.spark.sql.Row(2017,line._1,line._2,line._3,line._4,line._5,line._6,line._7))
...
//Create new DF with updated types
val df_School_Locations_2016_2017_final = df_School_Locations_2016_2017_ready.selectExpr("Year2",
    "DBN2",
    "Street",
    "City",
    "State",
