...
val df_EMS_SQR_2015_2016_final = df_EMS_SQR_2015_2016_ready.selectExpr("Year",
    "DBN",
    "School_Name",
    "School_Type",
    "cast(Enrollment as int) Enrollment",
...
//modify types of columns
val df_EMS_SQR_2016_2017_final = df_EMS_SQR_2016_2017_ready.selectExpr("Year",
    "DBN",
    "School_Name",
    "School_Type",
    "cast(Enrollment as int) Enrollment",
...
//modify types of columns
val df_HS_SQR_2015_2016_final = df_HS_SQR_2015_2016_ready.selectExpr("Year",
    "DBN",
    "School_Name",
    "School_Type",
    "cast(Enrollment as int) Enrollment",
...
//modify types of columns
val df_HS_SQR_2016_2017_final = df_HS_SQR_2016_2017_ready.selectExpr("Year",
    "DBN",
    "School_Name",
    "School_Type",
    "cast(Enrollment as int) Enrollment",
